...
public class LinePiece{
  ...
  public LinePiece(int x, int y){
    r1 = new Rectangle(Color.cyan);
    r2 = new Rectangle(Color.cyan);
    r3 = new Rectangle(Color.cyan);
    r4 = new Rectangle(Color.cyan);
    ...
    r3.setLocation(x,y+46);
    r4.setLocation(x,y+69);
  }
}
